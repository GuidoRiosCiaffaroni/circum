...
echo "git remote add origin origin https://github.com/GuidoRiosCiaffaroni/circum.git"
git remote add origin origin https://github.com/GuidoRiosCiaffaroni/circum.git
