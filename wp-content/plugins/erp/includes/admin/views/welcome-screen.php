<div class="wrap about-wrap">
    ...
    <ol>
        ...
        <li><?php printf( esc_html__( 'Create %s', 'erp' ), sprintf( '<a target="_blank" href="' . esc_url( admin_url( 'admin.php?page=erp-hr&section=people&sub-section=employee' ) ) . '">%s</a>', esc_html__( 'Employees', 'erp' ) ) ); ?></li>
    </ol>
