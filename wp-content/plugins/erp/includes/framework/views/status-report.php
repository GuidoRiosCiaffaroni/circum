...
<table class="erp_status_table widefat" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo esc_html( erp_format_date( erp_get_option( 'gen_com_start', 'erp_settings_general' ) ) ); ?></td>
		</tr>
		<tr>
			...
			<td><?php echo esc_html( erp_format_date( erp_financial_start_date() ) ); ?></td>
		</tr>
		<tr>
			...
			<td><?php echo esc_html( erp_format_date( erp_financial_end_date() ) ); ?></td>
		</tr>
		<tr>
...
<table class="erp_status_table widefat" cellspacing="0">
	...
	<tbody>
		...
		<?php
        $rows = apply_filters( 'erp_system_status_environment_rows', [] );
	...
	<tbody>
        ...
        foreach ( $active_plugins as $plugin ) {
            if ( ! empty( $plugin['name'] ) ) {
                ...
                echo ' &ndash; ' . esc_html( $plugin['version'] ); ?></td>
				</tr>
				<?php
            }
        }
