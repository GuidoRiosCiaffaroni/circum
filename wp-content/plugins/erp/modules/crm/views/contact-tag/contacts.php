<div class="wrap erp-crm-subscriber-contact" id="wp-erp">
    ...
    <h2><?php esc_html_e( 'Contacts', 'erp' ); ?>
        ...
        <a href="<?php echo  esc_url_raw( $contact_group_url ); ?>" class="add-new-h2" title="<?php esc_attr_e( 'Back to Contact Group', 'erp' ); ?>"><?php esc_html_e( 'Back to Contact Group', 'erp' ); ?></a>
    </h2>
