<div class="erp-crm-customer-make-wpuser" id="erp-crm-customer-make-wpuser">
    <# if ( '' == data.email ) { #>
        <div class="row">
            <label for="make-wp-user-customer-email"><?php esc_html_e( 'Enter your email', 'erp' ); ?></label>
            <input type="email" name="customeresc_attr_email" id="make-wp-user-customer-email" placeholder="<?php esc_attr_e( 'Enter your email', 'erp' ); ?>" required>
        </div>
    <# } #>
    <div class="row">
        <label for="wp-user-role"><?php esc_html_e( 'Role', 'erp' ); ?></label>
