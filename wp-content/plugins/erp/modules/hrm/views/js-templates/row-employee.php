<tr class="{{ data.class }}">
    ...
    <td class="username col- column-username">
        ...
        <div class="row-actions">
            <span class="edit"><a href="#" data-id="{{ data.id }}" title="<?php echo esc_attr__( 'Edit this item', 'erp' ); ?>"><?php esc_html_e( 'Edit', 'erp' ); ?></a> | </span>
            <span class="delete"><a class="submitdelete" data-id="{{ data.id }}" title="<?php echo esc_attr__( 'Delete this item', 'erp' ); ?>" href="#"><?php esc_html_e( 'Delete', 'erp' ); ?></a></span>
        </div>
    </td>
