...
<div class="mt mb f18 lh30">
  ...
  <div class="mm cf mbl">
    <div class="f20 bold mbll">
      <?php _e('Email notifications', 'backup-backup'); ?>
    </div>
  ...
  <div class="mm">
    <div class="f20 bold">
      <?php _e("Backup triggers", 'backup-backup'); ?>
    </div>
  ...
  <div class="mm mbl mtl">
    <div class="f20 bold">
      <?php _e("Change functionality of the plugin", 'backup-backup'); ?>
    </div>
    <div class="mtll">
      <span class="relative">
  ...
  <!--  -->
  <div class="mm f20 bold">
    <?php _e("Backup & Restore – PHP CLI Settings (advanced)", 'backup-backup'); ?>
  </div>
  ...
  <div class="mm mbl mtl">
    <div class="f20 bold">
      <?php _e("Change basic functions of the plugin", 'backup-backup'); ?>
    </div>
    <div class="mtll">
      <span class="relative">
        <?php _e("Backup downloading", 'backup-backup'); ?> <b><?php _e("technique", 'backup-backup'); ?></b>:
      </span>
    </div>
  ...
  <div class="mm mbl mtl">
    ...
    <div class="f20 bold">
      <?php _e("Database import/export settings", 'backup-backup'); ?>
    </div>
    <div class="mtll">
      <span class="relative">
  ...
  <div class="mm mbl">
    <div class="f20 bold">
      <?php _e("Clean-ups", 'backup-backup'); ?>
    </div>
    <div class="mtll">
      <span class="relative">
